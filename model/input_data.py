...
working_dirrectory = r"C:\Devel\test_issinfo\test"  #Как сделать так, чтобы iisinfo запускался из C:\\Program Files (x86)... я пока не понял, но это может сломать проверку в дженкинсе
...
path_to_archive = r'C:\workspace\tests-issinfo'
