...
working_dirrectory = r"C:\Devel\test_issinfo\tests\ISSInfo.7z"  #Как сделать так, чтобы iisinfo запускался из C:\\Program Files (x86)... я пока не понял, но это может сломать проверку в дженкинсе
...
working_dirrectory_jenkins_as_service = r"c:\workspace\tests-issinfo\ISSInfo.7z"